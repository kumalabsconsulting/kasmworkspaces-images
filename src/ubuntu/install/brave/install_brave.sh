...
# RETIRER l'option --no-sandbox fou la merde dans Brave
#CHROME_ARGS="--password-store=basic --ignore-gpu-blocklist --user-data-dir --no-first-run --check-for-update-interval=31449600"
